...
- 📹 **Video Streaming Backend** — A robust API prioritizing performance using **Node.js, MongoDB, Express.js, and Cloudinary**.
- 🤖 **AI Integration** — Intelligent web applications powered by **OpenAI & Gemini APIs** built with TypeScript.
